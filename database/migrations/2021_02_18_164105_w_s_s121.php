...
class WSS121 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $sql = "
                ...
                DROP FUNCTION IF EXISTS `get_status_code_by_id`;
                
                CREATE FUNCTION `get_status_code_by_id`(status_id INT) 
                RETURNS VARCHAR(150) 
                BEGIN
                    DECLARE status_code VARCHAR(150) DEFAULT NULL;
